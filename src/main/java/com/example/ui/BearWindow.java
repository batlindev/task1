...
public final class BearWindow {
    ...
    public static void open(String token, String chatId) {
        ...
        UiUtils.addRow(panel, "Minimap X (lewy-gorny):", mapX);
        UiUtils.addRow(panel, "Minimap Y (lewy-gorny):", mapY);
        UiUtils.addRow(panel, "Minimap szerokosc:", mapW);
        UiUtils.addRow(panel, "Minimap wysokosc:", mapH);
        UiUtils.addRow(panel, "Tolerancja koloru (+/-):", tolerance);
        UiUtils.addRow(panel, "Prog dotarcia (px):", arrive);
        UiUtils.addRow(panel, "Punkt 1 kolor (R,G,B):", point1Color);
        UiUtils.addRow(panel, "Punkt 2 kolor (R,G,B):", point2Color);
        UiUtils.addRow(panel, "Punkt 3 kolor (R,G,B):", point3Color);
        UiUtils.addRow(panel, "TARGET_X (atak):", targetX);
        UiUtils.addRow(panel, "TARGET_Y (atak):", targetY);
        ...
        UiUtils.addRow(panel, "BUTY X:", butyX);
        UiUtils.addRow(panel, "BUTY Y:", butyY);
        UiUtils.addRow(panel, "BUTY COLOR (R,G,B):", butyColor);
